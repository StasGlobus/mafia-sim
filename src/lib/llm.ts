...
export async function generateAgentLine(opts: LineRequest): Promise<string | null> {
  ...
  const sys = [
    ...
    "הודעה אחת, כמו מהטלפון. עד 12 מילים. משפט שבור מותר. בלי אימוג'ים כמעט.",
    ...
    "דוגמאות לטון הנכון (אל תעתיק, רק תרגיש את הסגנון): 'נו דני, שלוש הודעות ואף שם. על מי אתה?' | 'עזבו את נועה רגע, מי שדוחף אותה הכי חזק זה יובל' | 'אני על עומר. מצביע אחרון כל פעם' | 'לא. ולמה דווקא אני, קרן?' | 'רגע רגע, מישהו בדק למה איתי החליף צד?'",
